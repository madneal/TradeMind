...
## 固定策略（摘要）
技术面：S1 均线、S2 MACD、S3 RSI、S4 布林 → S5 合成净分。
经营过滤：F0 合规/ST 一票否决；F1 现金流/应收/毛利率质量（ETF 跳过）。
持仓纪律：P1 仓位、P2 ST、P3 深套、P4 黄金主题。
成本纪律 P5：浮亏时不主动卖出锁定亏损，除非基本面破坏（F0/F1 红灯或 ST）。
最终动作：买入 / 加仓 / 卖出 / 减仓 / 观望。
